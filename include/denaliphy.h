...
/**
    @defgroup grp_denali_phy_osil_ifc Denali Module OSIL Interface
    @ingroup grp_denali_phy

    @addtogroup grp_denali_phy_osil_ifc
    @{
...
*/
#define BRCM_SWARCH_DENALI_PHYFUNCTBL_GLOBAL    (0x8001U) /**< @brief #DENALI_PhyFuncTbl               */
/** @} */

/**
    @trace #BRCM_SWREQ_DENALI
*/
extern const ETHXCVR_ExtPhyFuncTblType DENALI_PhyFuncTbl;
