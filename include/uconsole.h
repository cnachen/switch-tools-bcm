...
#define BRCM_SWARCH_UCONSOLE_INITTXDATAQ_PROC (0x8103U)    /**< @brief #UCONSOLE_InitTxDataQ   */
#define BRCM_SWARCH_UCONSOLE_INITRXDATAQ_PROC (0x8104U)    /**< @brief #UCONSOLE_InitRxDataQ   */
/** @} */

/** @brief Initialize the uart Tx data Queue
    ...
    @limitations None
*/
extern void UCONSOLE_InitTxDataQ(void);

/** @brief Initialize the uart Rx data Queue
    ...
    @limitations None
*/
extern void UCONSOLE_InitRxDataQ(void);
