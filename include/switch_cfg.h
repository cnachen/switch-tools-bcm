...
*/
#define BRCM_SWARCH_ETHSWT_CFG_USR_DATA_GLOBAL        (0x8501U)    /**< @brief #ETHSWT_CfgUsrData  */
#define BRCM_SWARCH_ETHSWT_GET_PORT_CFG_PROC          (0x8502U)    /**< @brief #ETHSWT_GetPortCfg  */
#define BRCM_SWARCH_ETHSWT_GET_VLAN_PROC              (0x8503U)    /**< @brief #ETHSWT_GetVLAN     */
#define BRCM_SWARCH_ETHSWT_GET_VLAN_PORT_PROC         (0x8504U)    /**< @brief #ETHSWT_GetVLANPort */
#define BRCM_SWARCH_ETHSWT_JUMBO_FRM_GET_PROC         (0x8505U)    /**< @brief #ETHSWT_JumboFrmGet */
/** @} */
