...
/**
    @defgroup grp_bcm8956x_rom_ifc Interface
    @ingroup grp_bcm8956x_rom

    @addtogroup grp_bcm8956x_rom_ifc
    @{
    ...
    @tagseq bcm8956x_rom_early_init_seq_diagram.svg "Early Initialization Sequence diagram"
    @startseq
    ...
    Startup =>  ROM_Main [label = "BCM8956X_RomEarlyInit", return = "return"]{
    ...
    === Early Init Complete ===
    Startup ->  ROM_Main [label = "BCM8956X_RomMain", return = "return"];
    @endseq

    @tagseq bcm8956x_rom_driver_init_seq_diagram.svg "Driver Initialization Sequence diagram"
    @startseq
    group {label = "ROM_Main"; color = "#FFEFFF"; ROM_Main;};
    ...
    @tagseq bcm8956x_rom_tc10_init_seq_diagram.svg "TC10/XCVR Handling Sequence diagram"
    @startseq
    group {label = "ROM_Main"; color = "#FFEFFF"; ROM_Main;};
    ...
    @tagseq bcm8956x_rom_deinit_seq_diagram.svg "Deinitialization Sequence diagram"
    @startseq
    group {label = "ROM_Main"; color = "#FFEFFF"; ROM_Main;};
    ...
    @limitations LDocumented at @ref page_bcm8956x_rom
...
*/
#define BRCM_SWARCH_BCM8956X_ROM_EARLY_INIT_PROC    (0x8101U)    /**< @brief #BCM8956X_RomEarlyInit */
#define BRCM_SWARCH_BCM8956X_ROM_MAIN_PROC          (0x8102U)    /**< @brief #BCM8956X_RomMain      */
/** @} */
...
/** @brief Early Initialization for ROM application
    ...
    @pre Processor is initialized and Stack is setup and exceptions are disabled
    ...
    @trace #BRCM_SWREQ_BCM8956X_ROM

    @limitations TBD
*/
void BCM8956X_RomEarlyInit(void);
