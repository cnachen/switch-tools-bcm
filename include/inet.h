...
/**
  @defgroup grp_ethernet_abstract_inet_ifc INET Interface
  @ingroup grp_ethernet_abstract

  @addtogroup grp_ethernet_abstract_inet_ifc
  @{
  @file inet.h
 ...
 */
#define BRCM_SWARCH_INET_ENDPOINT_MAX_PAYLOAD_SIZE_MACRO (0x8601U) /**< @brief #INET_ENDPOINT_MAX_PAYLOAD_SIZE  */
#define BRCM_SWARCH_INET_IPADDRESS_TYPE                  (0x8602U) /**< @brief #INET_IPAddressType              */
#define BRCM_SWARCH_INET_PORT_TYPE                       (0x8603U) /**< @brief #INET_PortType                   */
#define BRCM_SWARCH_INET_ENDPOINTIPPORT_TYPE             (0x8604U) /**< @brief #INET_EndPointIPPortType         */
#define BRCM_SWARCH_INET_PAYLOAD_TYPE                    (0x8605U) /**< @brief #INET_PayloadType                */
#define BRCM_SWARCH_INET_BIND_PROC                       (0x8606U) /**< @brief #INET_Bind                       */
#define BRCM_SWARCH_INET_UNBIND_PROC                     (0x8607U) /**< @brief #INET_UnBind                     */
/** @} */
...
/**
    ...
    @trace #BRCM_SWREQ_INET
*/
typedef uint16_t INET_PayloadType;        /**< @brief Payload type */
#define INET_PAYLOAD_ID0            (0U)  /**< @brief Payload type 0 */
#define INET_PAYLOAD_ID1            (1U)  /**< @brief Payload type 1 */
#define INET_PAYLOAD_ID2            (2U)  /**< @brief Payload type 2 */
#define INET_PAYLOAD_ID3            (3U)  /**< @brief Payload type 3 */
#define INET_PAYLOAD_ID4            (4U)  /**< @brief Payload type 4 */
#define INET_PAYLOAD_ID5            (5U)  /**< @brief Payload type 5 */
#define INET_PAYLOAD_ID6            (6U)  /**< @brief Payload type 6 */
#define INET_PAYLOAD_ID7            (7U)  /**< @brief Payload type 7 */
#define INET_PAYLOAD_ID8            (8U)  /**< @brief Payload type 8 */
#define INET_PAYLOAD_ID9            (9U)  /**< @brief Payload type 9 */
#define INET_PAYLOAD_ID10           (10U) /**< @brief Payload type 10 */
#define INET_PAYLOAD_ID11           (11U) /**< @brief Payload type 11 */
/** @}*/

/**
    @brief Maximum size of INET Endpoint payload

    @trace #BRCM_SWREQ_INET
*/
#define INET_ENDPOINT_MAX_PAYLOAD_SIZE     (8UL)
...
BCM_STATIC_SIZE_ASSERT(INET_EndPointIPPortType, 8UL, INET_ENDPOINT_MAX_PAYLOAD_SIZE)
