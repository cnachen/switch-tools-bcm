...
#define BRCM_SWARCH_ETHSWT_NOTIFYLINKSTATUS_PROC           (0x8417U)    /**< @brief #ETHSWT_NotifyLinkStatus     */
#define BRCM_SWARCH_ETHSWT_GETXCVRID_PROC                  (0x8418U)    /**< @brief #ETHSWT_GetXcvrID            */
#define BRCM_SWARCH_ETHSWT_POLLLINKSTATUSCB_PROC           (0x8419U)    /**< @brief #ETHSWT_PollLinkStatusCB     */
/** @} */
...
/** @brief Ethernet Switch link state notification

    This API sends the link status to all it registered modules
    ...
    Return values are documented in reverse-chronological order
    @retval     #BCM_ERR_OK             Notification has been sent successfully
    @retval     #BCM_ERR_INVAL_PARAMS   (Invalid switch index)
    ...
    @limitations None
*/
int32_t ETHSWT_NotifyLinkStatus(ETHSWT_HwIDType aSwtID);
...
/**
    ...
    @trace #BRCM_SWREQ_ETHSWT_XCVR
*/
int32_t ETHSWT_GetXcvrID(ETHSWT_HwIDType aSwtID,
                         ETHSWT_PortIDType aPortID, uint32_t* const aXcvrID);

/**
    @brief API to poll the link status
    ...
    @trace #BRCM_SWREQ_ETHSWT_XCVR
*/
void ETHSWT_PollLinkStatusCB(void);
#endif /* ETHSWT_XCVR_H */
