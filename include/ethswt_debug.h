...
*/
#define BRCM_SWARCH_ETHSWT_SET_PORT_MIRROR_CFG_PROC        (0x8901U)    /**< @brief #ETHSWT_SetPortMirrorConfig  */
#define BRCM_SWARCH_ETHSWT_GET_PORT_MIRROR_CFG_PROC        (0x8902U)    /**< @brief #ETHSWT_GetPortMirrorConfig  */
#define BRCM_SWARCH_ETHSWT_SET_PORT_MIRROR_STATE_PROC      (0x8903U)    /**< @brief #ETHSWT_SetPortMirrorState   */
#define BRCM_SWARCH_ETHSWT_GET_PORT_MIRROR_STATE_PROC      (0x8904U)    /**< @brief #ETHSWT_GetPortMirrorState   */
#define BRCM_SWARCH_ETHSWT_GET_MIRROR_CAPTURE_PORT_PROC    (0x8905U)    /**< @brief #ETHSWT_GetMirrorCapturePort */
#define BRCM_SWARCH_ETHSWT_GET_RX_STAT_PROC                (0x8906U)    /**< @brief #ETHSWT_GetRxStat            */
#define BRCM_SWARCH_ETHSWT_GET_RX_STAT_V2_PROC             (0x8907U)    /**< @brief #ETHSWT_GetRxStatV2          */
#define BRCM_SWARCH_ETHSWT_CLEAR_RX_STAT_PROC              (0x8908U)    /**< @brief #ETHSWT_ClearRxStat          */
#define BRCM_SWARCH_ETHSWT_CLEAR_RX_STAT_V2_PROC           (0x8909U)    /**< @brief #ETHSWT_ClearRxStatV2        */
#define BRCM_SWARCH_ETHSWT_GET_TX_STAT_PROC                (0x890AU)    /**< @brief #ETHSWT_GetTxStat            */
#define BRCM_SWARCH_ETHSWT_GET_TX_STAT_V2_PROC             (0x890BU)    /**< @brief #ETHSWT_GetTxStatV2          */
#define BRCM_SWARCH_ETHSWT_CLEAR_TX_STAT_PROC              (0x890CU)    /**< @brief #ETHSWT_ClearTxStat          */
#define BRCM_SWARCH_ETHSWT_CLEAR_TX_STAT_V2_PROC           (0x890DU)    /**< @brief #ETHSWT_ClearTxStatV2        */
#define BRCM_SWARCH_ETHSWT_LED_TYPE                        (0x890EU)    /**< @brief #ETHSWT_LedType              */
#define BRCM_SWARCH_ETHSWT_SET_LED_STATE_PROC              (0x890FU)    /**< @brief #ETHSWT_SetLedState          */
#define BRCM_SWARCH_ETHSWT_GET_LEDSTATE_PROC               (0x8910U)    /**< @brief #ETHSWT_GetLedState          */
/** @} */
...
int32_t ETHSWT_SetPortMirrorConfig(ETHSWT_HwIDType aSwtID,
        ...
        ETHSWT_PortMirrorCfgV2Type *const aConfig);
...
/** @brief Get RX statistics
    ...
    @limitations None
*/
int32_t ETHSWT_GetRxStatV2(ETHSWT_HwIDType aSwtID,
                              ETHSWT_PortIDType aPortID,
                              ETHER_RxStatsV2Type *const aRxStat);
...
/** @brief Clear RX statistics
    ...
    @limitations None
*/
int32_t ETHSWT_ClearRxStatV2(ETHSWT_HwIDType aSwtID,
                                ETHSWT_PortIDType aPortID);
...
/** @brief Get TX statistics
    ...
    @limitations None
*/
int32_t ETHSWT_GetTxStatV2(ETHSWT_HwIDType aSwtID,
                              ETHSWT_PortIDType aPortID,
                              ETHER_TxStatsV2Type *const aTxStat);
...
/** @brief Clear TX statistics
    ...
    @limitations None
*/
int32_t ETHSWT_ClearTxStatV2(ETHSWT_HwIDType aSwtID,
                                ETHSWT_PortIDType aPortID);
