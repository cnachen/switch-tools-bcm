...
#define BRCM_SWARCH_MSGQ_MSGQ_INIT_HDRQ_MACRO      (0x8107U)    /**< @brief #MSGQ_INIT_HDRQ            */
#define BRCM_SWARCH_MSGQ_MSGQ_DEFINE_HDRQ_MACRO    (0x8108U)    /**< @brief #MSGQ_DEFINE_HDRQ          */
#define BRCM_SWARCH_MSGQ_CLIENT_SIGNAL_MACRO       (0x8109U)    /**< @brief #MSGQ_CLIENT_SIGNAL_ENABLE */
#define BRCM_SWARCH_MSGQ_MSG_QUEUE_TYPE            (0x810AU)    /**< @brief #MSGQ_Type                 */
#define BRCM_SWARCH_MSGQ_MSGQ_INIT_MACRO           (0x810BU)    /**< @brief #MSGQ_INIT                 */
#define BRCM_SWARCH_MSGQ_MSGQ_DEFINE_MACRO         (0x810CU)    /**< @brief #MSGQ_DEFINE               */
#define BRCM_SWARCH_MSGQ_MSGQ_DEFINE_V2_MACRO      (0x810DU)    /**< @brief #MSGQ_DEFINE_V2            */
#define BRCM_SWARCH_MSGQ_MSGQ_DEFINE_CTX_MACRO     (0x810EU)    /**< @brief #MSGQ_DEFINE_WITH_CONTEXT  */
#define BRCM_SWARCH_MSGQ_SEND_MSG_PROC             (0x810FU)    /**< @brief #MSGQ_SendMsg              */
#define BRCM_SWARCH_MSGQ_TRY_CANCEL_MSG_PROC       (0x8110U)    /**< @brief #MSGQ_TryCancelMsg         */
#define BRCM_SWARCH_MSGQ_RECV_MSG_PROC             (0x8111U)    /**< @brief #MSGQ_RecvMsg              */
#define BRCM_SWARCH_MSGQ_GET_MSG_IDX_PROC          (0x8112U)    /**< @brief #MSGQ_GetMsgIdx            */
#define BRCM_SWARCH_MSGQ_COMPLETE_MSG_IDX_PROC     (0x8113U)    /**< @brief #MSGQ_CompleteMsgIdx       */
#define BRCM_SWARCH_MSGQ_GET_MSG_TYPE              (0x8114U)    /**< @brief #MSGQ_GetMsgType           */
#define BRCM_SWARCH_MSGQ_GET_MSG_V2_TYPE           (0x8115U)    /**< @brief #MSGQ_GetMsgV2Type         */
#define BRCM_SWARCH_MSGQ_MSGQ_DEFINE_V3_MACRO      (0x8116U)    /**< @brief #MSGQ_DEFINE_V3            */
#define BRCM_SWARCH_MSGQ_MSGQ_DEFINE_V4_MACRO      (0x8117U)    /**< @brief #MSGQ_DEFINE_V4            */
#define BRCM_SWARCH_MSGQ_VERSION_TYPE              (0x8118U)    /**< @brief #MSGQ_VersionType          */
#define BRCM_SWARCH_MSGQ_CTX_CREATE_PROC           (0x8119U)    /**< @brief #MSGQ_CtxCreate            */
#define BRCM_SWARCH_MSGQ_CTX_SEND_MSG_PROC         (0x811AU)    /**< @brief #MSGQ_CtxSendMsg           */
#define BRCM_SWARCH_MSGQ_CTX_TRY_CANCEL_MSG_PROC   (0x811BU)    /**< @brief #MSGQ_CtxTryCancelMsg      */
#define BRCM_SWARCH_MSGQ_CTX_RECV_MSG_PROC         (0x811CU)    /**< @brief #MSGQ_CtxRecvMsg           */
#define BRCM_SWARCH_MSGQ_CTX_DESTROY_PROC          (0x811DU)    /**< @brief #MSGQ_CtxDestroy           */
#define BRCM_SWARCH_MSGQ_CTX_GET_MSG_IDX_PROC      (0x811EU)    /**< @brief #MSGQ_CtxGetMsgIdx         */
#define BRCM_SWARCH_MSGQ_CTX_COMPLETE_MSG_IDX_PROC (0x811FU)    /**< @brief #MSGQ_CtxCompleteMsgIdx    */
#define BRCM_SWARCH_MSGQ_CTX_GET_HDL_PROC          (0x8120U)    /**< @brief #MSGQ_CtxGetHdl            */
#define BRCM_SWARCH_MSGQ_IS_HDL_VALID_PROC         (0x8121U)    /**< @brief #MSGQ_IsHdlValid           */
#define BRCM_SWARCH_MSGQ_MSGQ_INIT_CTX_MACRO       (0x8122U)    /**< @brief #MSGQ_INIT_WITH_CONTEXT    */
#define BRCM_SWARCH_MSGQ_HDRQ_TYPE                 (0x8123U)    /**< @brief #MSGQ_HdrQType             */
#define BRCM_SWARCH_MSGQ_GET_SERVER_TYPE           (0x8124U)    /**< @brief #MSGQ_GetServerType        */
#define BRCM_SWARCH_MSGQ_MSGQ_INIT_V2_MACRO        (0x8125U)    /**< @brief #MSGQ_INIT_V2              */
#define BRCM_SWARCH_MSGQ_SEND_MSG_V2_PROC          (0x8126U)    /**< @brief #MSGQ_SendMsgv2            */
#define BRCM_SWARCH_MSGQ_TRY_CANCEL_MSG_V2_PROC    (0x8127U)    /**< @brief #MSGQ_TryCancelMsgv2       */
#define BRCM_SWARCH_MSGQ_RECV_MSG_V2_PROC          (0x8128U)    /**< @brief #MSGQ_RecvMsgv2            */
#define BRCM_SWARCH_MSGQ_MSGQ_INIT_V2_CTX_MACRO    (0x8129U)    /**< @brief #MSGQ_INIT_V2_WITH_CONTEXT */
#define BRCM_SWARCH_MSGQ_GET_CLIENT_ID_PROC        (0x812AU)    /**< @brief #MSGQ_GetClientID          */
/** @} */
...
#define MSGQ_INVALID_CLIENT (0xFFFFFFFFUL)  /**< @brief Invalid Message Queue client ID*/
...
typedef struct sMSGQ_MsgInfoType {
    ...
    uint32_t            clientID;   /**< @brief Task ID of client to signal upon
...
/** @brief Get the i'th message from the server
    ...
    This API is used by the Message Queue framework to retrieve the message
    corressponding to the index @c aMsgIdx. This function shall be defined by
    the server and a pointer (i.e. function pointer) provided while defining
    the Message Queue.
    ...
    @note This API is always invoked with a valid Message index
...
/** @brief Get Server details
    ...
    @limitations None
*/
typedef void (*MSGQ_GetServerType)(uint32_t *aServerTask, uint32_t *aServerEvent);
...
typedef struct sMSGQ_Type {
    ...
    uint32_t            serverID;   /**< @brief Task ID of server to be signaled
...
/** @brief Get Client Task ID

    API to be called by server to fetch the client Task ID
    ...
    @param[out]     aClientTaskID  Pointer to client Task ID

    Return values are documented in reverse-chronological order
    @retval     #BCM_ERR_OK             Client Task ID Fetched
    @retval     #BCM_ERR_UNKNOWN        Unknown error while fetching client ID
    @retval     #BCM_ERR_INVAL_PARAMS   API called from wrong state

    @retval     #BCM_ERR_INVAL_PARAMS   idx is not valid
    @retval     #BCM_ERR_INVAL_PARAMS   msgQ does not have a valid
                                        magic
    @retval     #BCM_ERR_INVAL_PARAMS   msgQ is NULL
    @retval     #BCM_ERR_AUTH_FAILED    Calling task is not authorized
    ...
    @limitations This API shall be called only from server task context.
*/
int32_t MSGQ_GetClientID(const MSGQ_Type* const aMsgQ,
                            const uint32_t aIdx, uint32_t *aClientTaskID);
