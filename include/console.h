...
/**
    @brief API to set the console for logging user-space logs

    This API is used to set the console over which the User-space logs are logged.
...
/**
    @brief API to read from a console

    Read the contents of the buffer from the given console.

    @param[in]   aConsoleID      Console to which the buffer is to be read from.
...
/** @brief initialize the Console's data Queue
*/
void CONSOLE_InitDataQ(void);
