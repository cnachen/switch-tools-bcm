...
#define BRCM_SWARCH_NIF_XCVRGETSQIVALUE_PROC             (0x8608U)    /**< @brief #NIF_XcvrGetSQIValue              */
#define BRCM_SWARCH_NIF_XCVRCTRLCFG_GLOBAL               (0x8609U)    /**< @brief #NIF_XcvrCtrlCfg                  */
#define BRCM_SWARCH_NIF_XCVRCTRLCONFIG_GLOBAL            (0x860AU)    /**< @brief #NIF_XcvrCtrlConfig               */
/** @} */
