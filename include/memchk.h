...
******************************************************************************/
/**
    @defgroup grp_memchk_ifc Memory tests
    @ingroup grp_memchk

    @addtogroup grp_memchk_ifc
    @{
...
*/
#define BRCM_SWARCH_BCM_MEMCHK_PROC           (0x8301U)    /**< @brief #BCM_MemTest        */
#define BRCM_SWARCH_BCM_MEMCHKNOSTACK_PROC    (0x8302U)    /**< @brief #BCM_MemTestNoStack */
#define BRCM_SWARCH_BCM_MEMCHKMARCHC_PROC     (0x8303U)    /**< @brief #BCM_MemTestMarchC  */
#define BRCM_SWARCH_BCM_MEMCHKHAMMER_PROC     (0x8304U)    /**< @brief #BCM_MemTestHammer  */
/** @} */
