...
#define BRCM_SWARCH_NIF_CLIENTBUFIDX_TYPE             (0x8523U)    /**< @brief #NIF_ClientBufIdxType         */
#define BRCM_SWARCH_NIF_GETCLIENTBUFINDX_MACRO        (0x8524U)    /**< @brief #NIF_GETCLIENTBUFINDX         */
#define BRCM_SWARCH_NIF_CLIENTETHER_TYPE              (0x8525U)    /**< @brief #NIF_ClientEtherType          */
#define BRCM_SWARCH_NIF_GETETHERTYPE_MACRO            (0x8526U)    /**< @brief #NIF_GETETHERTYPE             */
#define BRCM_SWARCH_NIF_DEINIT_PROC                   (0x8527U)    /**< @brief #NIF_DeInit                   */
#define BRCM_SWARCH_NIF_SEND_DBG_PKT_PROC             (0x8528U)    /**< @brief #NIF_SendDbgPkt               */
/** @} */
...
/**
    @name NIF Client Buf Index Type
    @{

    @trace #BRCM_SWREQ_NIF_CONFIG
*/
typedef uint32_t NIF_ClientBufIdxType;                 /**< @brief Values for Client Buf Index composition  */
#define NIF_CLIENTBUFIDX_SHIFT          (0ULL)     /**< @brief Shift for client Buf Index type */
#define NIF_CLIENTBUFIDX_MASK           (0xFFFFULL)  /**< @brief Mask for client Buf Index type */
/** @} */

/**
    @brief NIF Client Buf Index

    macro used to get Cleint BUf Index value.

    @trace #BRCM_SWREQ_NIF_CONFIG
*/
#define NIF_GETCLIENTBUFINDX(bufIdx) \
                    (uint32_t)(((bufIdx) & NIF_CLIENTBUFIDX_MASK) >> NIF_CLIENTBUFIDX_SHIFT)

/**
    @name NIF Client Ether Type
    @{

    @trace #BRCM_SWREQ_NIF_CONFIG
*/
typedef uint32_t NIF_ClientEtherType;                 /**< @brief Values Ethernet Type composition  */
#define NIF_CLIENTETHERTYPE_SHIFT          (16ULL)     /**< @brief Shift for Ethernet type */
#define NIF_CLIENTETHERTYPE_MASK           (0xFFFF0000ULL)  /**< @brief Mask for ethernet type */
/** @} */

/**
    @brief NIF Client EtherType

    macro used to get Client Ether Type.

    @trace #BRCM_SWREQ_NIF_CONFIG
*/

#define NIF_GETETHERTYPE(bufIdx) \
                    (((bufIdx) & NIF_CLIENTETHERTYPE_MASK) >> NIF_CLIENTETHERTYPE_SHIFT)
...
/** @brief Get transmit buffer
    ...
    @limitations None
*/
typedef int32_t (*NIF_EthGetTxBufferType)(const uint64_t aCtrlId, ETHER_PrioType aPriority,
                                          uint64_t *const aBufIdx, uint8_t **const aBuf,
                                          uint32_t *const aLenInOut,const ETHER_EtherType aEtherType);
...
/** @brief Send transmit buffer
    ...
    @limitations None
*/
typedef int32_t (*NIF_EthSendType)(const uint64_t aCtrlId, uint32_t aTxConfirmation,
                                   uint64_t aBufIdx, uint32_t aLen,
                                   const uint8_t *const aSrcMacAddr,
                                   const uint8_t *const aDestMacAddr);
...
/** @brief NIF De-Initializiation

    This API De-Initilizesz Ethernet system layer which is interfaced by NIF.
    ...
    layer
*/
extern int32_t NIF_DeInit(void);
...
extern int32_t NIF_Send(NIF_CntrlIDType aCtrlIdx,
                        ETHER_EtherType aEtherType,
                        BCM_BoolType aIsTxConfEnable,
                        uint64_t aBufIdx,
                        uint32_t aLen,
                        const uint8_t *const aDestMacAddr);

/** @brief Send Debug Ethernet packet

    This API sends an ethernet packet.
    ...
    @param[in]       aID                     Ethernet controller id
    @param[in]       aPkt                    Debug packet details
    ...
    @trace #BRCM_SWREQ_NIF_TRANSMIT
*/
extern int32_t NIF_SendDbgPkt(ETHER_HwIDType aID, ETHER_DbgPktType *const aPkt);
