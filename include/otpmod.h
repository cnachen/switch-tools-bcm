...
/** @defgroup grp_otpmod_ifc Interface
    @ingroup grp_otpm

    @addtogroup grp_otpmod_ifc
    @{
...
/**
    @name OTP Module Interface IDs
    @{
    @brief OTP Module Interface IDs
*/
#define BRCM_SWARCH_OTPM_MODULE_GLOBAL         (0x8800U) /**< @brief #OTPM_Module      */
/** @} */
