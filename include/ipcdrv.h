...
/**
    ...
    @image html ipcdrv_block_diagram_dio.png "IPC Block Diagram"
...
#define BRCM_SWARCH_IPC_NOTIFYCOUNTERINC_PROC         (0x810DU) /**< @brief #IPC_NotifCounterInc */
/** @} */
...
/** @brief Increment the notification counter
    ...
    @limitations None
*/
void IPC_NotifCounterInc(IPC_ChannIDType aID);
