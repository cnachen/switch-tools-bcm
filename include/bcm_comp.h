...
#define BCM_SKADRV_ID  (0x0405U)   /**< @brief SKADRV                 */
...
#define BCM_CSRBG_ID   (0x0423U)   /**< @brief CS RAND BYTE GEN       */
...
#define BCM_XFI_ID    (0x050DU)   /**< @brief XFI Module             */
...
typedef struct sBCM_NotifyDataType {
    uint32_t       payload[BCM_NOTIFY_CUSTDATA_MAX];
} BCM_NotifyDataType;
...
typedef struct sBCM_NotifyMsgType {
    ...
    BCM_NotifyDataType      data;
} BCM_NotifyMsgType;

/**
    @brief Maximum string size that is filled by @ref BCM_ConvertCompToStr
