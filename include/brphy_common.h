...
******************************************************************************/
/**
    @defgroup grp_xcvr_brphydrv_common_imp BRPHY Driver common Interface
    @ingroup grp_xcvr_brphydrv

    @addtogroup grp_xcvr_brphydrv_common_imp
    @{
...
#define BRCM_SWARCH_BRPHY_COMMONIRQHANDLER_PROC              (0x8325U)    /**< @brief #BRPHY_CommonIRQHandler           */
/** @} */
...
extern BRPHY_RWDataType
    BRPHY_RWData[BRPHY_MAX_HW_INSTANCE_ID] COMP_SECTION(".bss.drivers");
...
/**
    @trace #BRCM_SWREQ_BRPHY_FUNCTBL
*/
int32_t BRPHY_CommonIRQHandler(uint8_t aPhyIdx,
                                   ETHXCVR_CntxtType *const aPhyCntxt,
                                   const ETHXCVR_PortConfigType *const aConfig,
